...
#SBATCH --output=/home/mp7563/Jobs_logs/Soybean_jobs/%A_%a_soybean_realign_heat.out
#SBATCH --error=/home/mp7563/Jobs_logs/Soybean_jobs/%A_%a_soybean_realign_heat.err
...
FASTQ_LIST=(
  "/projects/rps/cgsb/bergelson/bergelson-lab/Michael_P/Collaborator_data/Raw_fastq_files/GR00_Rep1/Leaf_heat1/RNA_LeafH1"
...
mkdir -p /projects/rps/cgsb/bergelson/bergelson-lab/Michael_P/Soybean_results/realigned_sc/heat
cd /projects/rps/cgsb/bergelson/bergelson-lab/Michael_P/Soybean_results/realigned_sc/heat || exit 1
